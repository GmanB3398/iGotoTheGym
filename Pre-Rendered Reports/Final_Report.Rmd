...
As anyone who has been to the gym can tell you, the effects do not happen right away. While picking up my phone is not the same as losing weight or gaining muscle, it would be naïve to assume that my response variable is an immediate effect. In a further experiment, it might be effective to look at pickups over a whole week where weeks are all assigned different amounts of exercise.
